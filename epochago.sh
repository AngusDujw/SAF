...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m torch.distributed.launch --nproc_per_node=8 --nnodes=$rank_num \
	...
	3epochago.py  /home/djw/data/imagenet --model resnet50 -b 256 --sched cosine --epochs 300 \
	--reinforce 0.3 --kl_start_epoch 100 --kl_end_epoch 300 --minus_epoch 3 --temperature --KL_all_indices \

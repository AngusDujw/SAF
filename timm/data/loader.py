...
def fast_collate(batch):
    ...
    # __import__('ForkedPdb').ForkedPdb().set_trace()
    ...
    if isinstance(batch[0][0], tuple):
        ...
        indices = torch.tensor([b[0] for b in batch], dtype=torch.int64)
    ...
    def __iter__(self):
        ...
        for next_index,next_input, next_target in self.loader:
            with torch.cuda.stream(stream):
                ...
                next_index = next_index.cuda(non_blocking=True)
                if self.fp16:
